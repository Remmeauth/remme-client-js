...
var RemmeTransactionService = /** @class */ (function () {
    ...
    RemmeTransactionService.prototype._generateHash = function (value) {
        return crypto_1.createHash("sha512").update(Buffer.from(value)).digest("hex");
    };
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        transactionHeaderBytes = protobuf.TransactionHeader.encode({
                            ...
                            nonce: this._generateHash(Math.floor(Math.random() * 1000).toString()),
                            batcherPublicKey: batcherPublicKey,
                            // payloadSha512: this.generateHash(payloadBytes.toString()),
                            payloadSha512: functions_1.sha512(payloadBytes),
                        }).finish();
