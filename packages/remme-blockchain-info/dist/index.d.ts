...
import { IBaseQuery, Batch, BatchList, Block, BlockList, State, StateList, Transaction, TransactionList, PeerList, ReceiptList, IStateQuery, INetworkStatus, IBlockInfo } from "./models";
