...
var RemmeBlockchainInfo = /** @class */ (function () {
    ...
    RemmeBlockchainInfo.prototype.getBatchStatus = function (batchId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._remmeRest.getRequest(remme_rest_1.RemmeMethods.batchStatus, { batch_id: batchId })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
