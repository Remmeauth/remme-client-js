import { IBaseQuery, TransactionList, Transaction, BlockList, Block, BatchList, Batch, IStateQuery, StateList, State, PeerList, ReceiptList, INetworkStatus, IBlockInfo } from "./models";
