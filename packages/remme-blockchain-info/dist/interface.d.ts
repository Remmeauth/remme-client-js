import { IBaseQuery, TransactionList, Transaction, TransactionData, BlockList, Block, BatchList, Batch, IStateQuery, StateList, State, INetworkStatus, IBlockInfo } from "./models";
